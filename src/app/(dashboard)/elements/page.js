  ...
  return (
    <div>
      ...
      <Card colour="" icon="fa-cubes" title="Layout Examples">
        <h3 className="center">
          This page demonstrates some custom components and CSS elements for
          layout and styling.
        </h3>
      </Card>
    ...
    <div className="col">Column 2</div>
          ...
          <div className="col">
            <h3>Explanation</h3>
            <p>
              Use the .row and .col classes to create a flexible two-column
              layout. The columns will adjust their width based on the available
              space.
            </p>
            <p>
              This is useful for creating responsive designs that adapt to
              different screen sizes.
            </p>
            <p>
              It is possible to add additional columns by simply adding more
              .col divs within the .row.
            </p>
          </div>
        </div>
      </Card>
