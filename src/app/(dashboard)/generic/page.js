...
export const metadata = {
    title: 'Generic Page',
    description: 'Examples of a generic page layout with header, footer, and sidebar.',
};
...
export default function pageDemo() {
    ...
    // Random Icon
    const icons = ['fa-car', 'fa-tree', 'fa-heart', 'fa-star', 'fa-moon', 'fa-sun', 'fa-cloud', 'fa-bicycle', 'fa-bus', 'fa-rocket', 'fa-ship', 'fa-plane', 'fa-motorcycle', 'fa-train', 'fa-truck'];
    ...
    return (
        <div>
            ...
            <Card colour={randomColour} icon={randomIcon} title="Card Title">
                ...
                <br/>
                <p>Reload the page to see different random colours and icons (and the generated example HTML).</p>
            </Card>
