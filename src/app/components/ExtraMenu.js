    ...
    return (
        <aside className="extra">
            <Card title="Hourly Trend" icon="fas fa-fw fa-chart-line" colour="red">
                <p>Fluid Tracker is a sample application demonstrating a responsive layout using Next.js and React.</p>
            </Card>
            ...
            <Card title="About Fluid Tracker" icon="fas fa-fw fa-droplet" colour="green">
                <p>Fluid Tracker is a sample application demonstrating a responsive layout using Next.js and React.</p>
            </Card>
        </aside>
    );
